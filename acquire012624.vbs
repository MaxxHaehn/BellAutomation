...
sunfile = "C:\Users\Bell\Documents\Acquire\suncoords.txt"
...
End If
Do While Not dome.AtHome = True
	objFile.Write FormatDateTime(now, 3) & " - " & "Dome is not home, try homing again" & vbCrLf
	dome.FindHome
	WScript.Sleep 5000
	If dome.AtHome = True Then
		objFile.Write FormatDateTime(now, 3) & " - " & "Dome homed" & vbCrLf
...
Off=0
Set f = fso.OpenTextFile( "C:\Users\Bell\Documents\Acquire\BiasList.txt", 1 )
...
'wscript.echo "End of " & TargetList
...
Sub Process( Line )
	...
	If Left( Command, 2 ) = "RA" Then
		...
		If Not HasRA Then Error = "Missing right ascension"
	ElseIf Left( Command, 3 ) = "DEC" Then
		Dec = Util.DMSToDegrees(Line)
		Decunmod = Line
		HasDec = Dec <> 0 Or InStr( Line, "0" ) > 0
		If Not HasDec Then Error = "Missing declination"
...
Sub TakeExposure( Duration )
	...
	shell.Run "C:\Users\Bell\Documents\checksuncoords.bat"
	WScript.Sleep 3000
	sunfile = "C:\Users\Bell\Documents\Acquire\suncoords.txt"
	Set fsun = fso.OpenTextFile(sunfile)
	sunaltnow = fsun.Read(8)
	...
	target_folder = "C\Users\Bell\Documents\Acquire"
	If fso.FileExists( "C\Users\Bell\Documents\Acquire\PWILog.txt") Then
	...
	If az <> "" Then Camera.SetFITSKey "OBJECTAZ", azunmod
	If alt <> "" Then Camera.SetFITSKey "OBJECTALT", altunmod
...
Sub PrepareToImage
	...
	If HasRA And HasDec Then
		...
		Tel.send
		Tel.open "GET", "http://localhost:8220/rotator/enable", False
		Tel.send
...
Sub MoonCheck
	...
	moongood = Empty
	totaldistance = Empty
	shell.Run "C:\Users\Bell\Documents\Acquire\checkmooncoords.bat"
	WScript.Sleep 2000

	mooncoordsfile = "C:\Users\Bell\Documents\Acquire\mooncoords.txt"
	...
	ElseIf totaldistance <= 20 Then
		moongood = False
		moongoodstr = "Too close to the moon!"
	End If
	'WScript.Echo totaldistance
	'WScript.Echo moongoodstr
	fmoon.Close
	fmoon.Close
	Set fmoon = Nothing
End Sub
